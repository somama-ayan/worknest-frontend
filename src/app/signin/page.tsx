    ...
    return (
        <div className="flex justify-center">
            <section className="mb-10 w-96 h-full bg-[rgba(8,36,80,0.6)] backdrop-blur-[20px] p-8 lg:p-12 rounded-[2rem] shadow-[0px_12px_32px_rgba(0,0,0,0.4)] border border-outline-variant/20">
                <div className="mb-10">
                    <h2 className="text-white text-3xl my-2">Welcome Back</h2>
                    <p className="leading-relaxed text-[#95abde] my-2">Authenticate to enter the nest.</p>
                </div>
                <form className="space-y-8">
                    ...
                    <div className="space-y-2">
                        <button className="w-full bg-[linear-gradient(90deg,#c0c1ff_0%,#6a6cff_50%,#2f2ebe_100%)] rounded-xl text-[#2724b8] mx-3 px-5 py-3 shadow-[0px_12px_32px_rgba(47,46,190,0.3)] hover:scale-105 transition-transform duration-300">Sign In</button>
                    </div>
